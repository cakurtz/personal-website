...
var FileRetrievalService = /** @class */ (function () {
    function FileRetrievalService() {
        this.params = {
            Prefix: 'images/'
        };
    ...
    FileRetrievalService.prototype.getS3ObjectList = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.s3.listObjects(_this.params, function (err, data) {
                if (err) {
                    console.log(err);
                    reject();
                }
...
var GalleryBar = /** @class */ (function () {
    function GalleryBar(fileRetrievalService) {
    ...
    GalleryBar.prototype.ngOnInit = function () {
        var _this = this;
        this.iconMap = new Map();
        this.categoryNames = [];
        this.iconPaths = [];
        this.fileRetrievalService.getS3ObjectList().then(function (result) {
            _this.barLength = result.length;
            _this.urlPaths = _this.extractUrlPath(result);
            _this.extractCategoryNames();
        });
    };
    GalleryBar.prototype.extractUrlPath = function (data) {
        var e_1, _a;
        var urls = [];
        try {
    ...
    GalleryBar.prototype.extractCategoryNames = function () {
        var e_2, _a;
        var currentPath = "";
        var currentCategory = "";
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.urlPaths), _c = _b.next(); !_c.done; _c = _b.next()) {
                var path = _c.value;
                ...
                if (path.startsWith(currentPath + this.iconPath) && path.endsWith(this.imageEnding)) {
                    var categoryValues = this.iconMap.get(currentCategory);
    ...
    GalleryBar.prototype.extractIconsForCategory = function (category) {
        var e_3, _a;
        var mapIconPaths = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.urlPaths), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    GalleryBar.prototype.getIcons = function (category) {
        return this.iconMap.get(category);
    };
    GalleryBar.ctorParameters = function () { return [
